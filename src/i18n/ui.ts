...
export const ui = {
  es: {
    ...
    'language.ca': 'Catalán',
    'language.en': 'Inglés',
    'blog.meta.title': 'Blog de Tecnología, IA, Desarrollo de software y subvenciones',
    'blog.meta.description': 'Novedades sobre desarrollo de software a medida, inteligencia artificial, automatización y subvenciones tecnológicas, desde la comarca de Osona (Barcelona).',
    ...
    'contact.companySize': 'Tamaño de la empresa',
  ...
  ca: {
    ...
    'language.ca': 'Català',
    'language.en': 'Anglès',
    'blog.meta.title': 'Blog de Tecnologia, IA, Desenvolupament de software i subvencions',
    'blog.meta.description': 'Novetats sobre Gilsys, desenvolupament de software a mida, intel·ligència artificial, automatització i subvencions tecnològiques, des d’Osona (Barcelona).',
    ...
    'contact.company': 'Empresa',
    'contact.companySize': "Grandària de l'empresa",
  ...
  en: {
    ...
    'language.ca': 'Catalan',
    'language.en': 'English',
    'blog.meta.title': 'Blog about Software Development and AI',
    'blog.meta.description': 'News about custom software development, artificial intelligence, automation, and technology from Barcelona (Spain).',
    ...
    'blog.list.subtitle': 'News and insights on custom software development, artificial intelligence, and automation. Technology articles and analysis from Barcelona.',
    'contact.title': 'What can we do for you?',
    'contact.subtitle': 'Fill out the form to request more information about our services, schedule a meeting, request a quote, or simply send a message.',
...
export const routes = {
  ca: {
    ...
    'kit-consulting/ai-advisory': '/ca/kit-consulting-catalunya/intelligencia-artificial/',
    'kit-consulting/basic-data-analysis': '/ca/kit-consulting-catalunya/analisi-dades-basic/',
    'kit-consulting/advanced-data-analysis':'/ca/kit-consulting-catalunya/analisi-dades-avancat/',
    'kit-consulting': '/ca/kit-consulting-catalunya/',
    'kit-consulting/digital-sales-advisory': '/ca/kit-consulting-catalunya/vendes-digitals/',
    'kit-consulting/business-process-advisory': '/ca/kit-consulting-catalunya/processos-negoci-produccio/',
    'kit-consulting/business-strategy-advisory': '/ca/kit-consulting-catalunya/estrategia-rendiment-negoci/',
    'kit-consulting/360-digital-transformation': '/ca/kit-consulting-catalunya/transformacion-digital-360/',
    ...
    'technology/java': '/ca/tecnologia/programadors-java/',
    'technology/javascript': '/ca/tecnologia/programadors-javascript/',
  ...
  es: {
    ...
    'kit-consulting/ai-advisory': '/es/kit-consulting/inteligencia-artificial/',
    'kit-consulting/basic-data-analysis': '/es/kit-consulting/analisis-datos-basico/',
    'kit-consulting/advanced-data-analysis': '/es/kit-consulting/analisis-datos-avanzado/',
    'kit-consulting/digital-sales-advisory': '/es/kit-consulting/ventas-digitales/',
    'kit-consulting/business-process-advisory': '/es/kit-consulting/procesos-negocio-produccion/',
    'kit-consulting/business-strategy-advisory': '/es/kit-consulting/estrategia-rendimiento-negocio/',
    'kit-consulting/360-digital-transformation': '/es/kit-consulting/transformacion-digital-360/',
  ...
  en: {
    ...
    'technology/php' : '/en/technology/php-developers/',
    'technology/react-native' : '/en/technology/react-native-developers/',
    'technology/angular' : '/en/technology/angular-developers/',
    'technology/metronic' : '/en/technology/metronic-developers/',
    'technology/slim-framework' : '/en/technology/slim-framework-developers/',
    'technology/tailwind' : '/en/technology/tailwind-developers/',
    'technology/bootstrap' : '/en/technology/bootstrap-developers/',
    'technology/mysql': '/en/technology/mysql-developers/',
    'technology/oracle': '/en/technology/oracle-developers/',
    'technology/mongodb': '/en/technology/mongodb-developers/',
    'technology/java': '/en/technology/java-developers/',
    'technology/javascript': '/en/technology/javascript-developers/',
    'technology/html-css': '/en/technology/html-css-developers/',
    'technology/astro': '/en/technology/astro-developers/',
  },
};
        ...
        links: [
          {
            ...
            title: 'Asesoramiento en la implementación de IA',
            text: 'Asesoramiento en inteligencia artificial',
            icon: 'tabler:brain',
          },
          {
            href: routes['es']['kit-consulting/advanced-data-analysis'],
            title: 'Análisis de datos avanzado para mejorar estrategias',
