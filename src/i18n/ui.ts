...
export const ui = {
  ...
  ca: {
    ...
    'blog.meta.description': 'Novetats sobre desenvolupament de software a mida, intel·ligència artificial, automatització i subvencions tecnològiques, des de la comarca d’Osona (Barcelona).',
